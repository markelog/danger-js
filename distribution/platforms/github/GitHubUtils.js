...
exports.createUpdatedIssueWithIDGenerator = function (api) { return function (id, content, settings) { return __awaiter(_this, void 0, void 0, function () {
    var uniqueHeader, searchResults, body, repo, owner, title, state, issueToUpdate, issue, issue;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                uniqueHeader = "Danger-ID: " + id.replace(/ /g, "_");
                return [4 /*yield*/, api.search.issues({ q: uniqueHeader })];
            case 1:
